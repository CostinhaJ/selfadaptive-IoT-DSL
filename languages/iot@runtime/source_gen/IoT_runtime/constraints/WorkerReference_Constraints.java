...
public class WorkerReference_Constraints extends BaseConstraintsDescriptor {
  ...
  protected Map<SReferenceLink, ReferenceConstraintsDescriptor> getSpecifiedReferences() {
    BaseReferenceConstraintsDescriptor d0 = new BaseReferenceConstraintsDescriptor(LINKS.worker$lDxU, this) {
      @Override
      ...
      public ReferenceScopeProvider getScopeProvider() {
        return new BaseScopeProvider() {
          ...
          public SNodeReference getSearchScopeValidatorNode() {
            return breakingNode_eonr4i_a0a0a0a0a1a0a0a0c;
          }
          @Override
  ...
  private static final SNodePointer breakingNode_eonr4i_a0a0a0a0a1a0a0a0c = new SNodePointer("r:ef5b13d7-d5e8-4ebf-a18f-76c256afe20a(IoT_runtime.constraints)", "3242911558877163249");
