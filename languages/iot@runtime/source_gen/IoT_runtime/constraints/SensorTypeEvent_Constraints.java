...
public class SensorTypeEvent_Constraints extends BaseConstraintsDescriptor {
  ...
  protected Map<SReferenceLink, ReferenceConstraintsDescriptor> getSpecifiedReferences() {
    BaseReferenceConstraintsDescriptor d0 = new BaseReferenceConstraintsDescriptor(LINKS.sensorType$YlTT, this) {
      @Override
      ...
      public ReferenceScopeProvider getScopeProvider() {
        return new BaseScopeProvider() {
          ...
          public SNodeReference getSearchScopeValidatorNode() {
            return breakingNode_ozovf2_a0a0a0a0a1a0a0a0c;
          }
          @Override
  ...
  private static final SNodePointer breakingNode_ozovf2_a0a0a0a0a1a0a0a0c = new SNodePointer("r:ef5b13d7-d5e8-4ebf-a18f-76c256afe20a(IoT_runtime.constraints)", "5982629958615616712");
